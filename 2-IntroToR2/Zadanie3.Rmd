...
W celu wykoniania zadania nr.2, wybrany został pakiet ***ADAPTS***. Jest to narzędzie do konstruowania (lub dodawania) macierzy sygnatur typu komórkowego przy użyciu próbek sortowanych przepływowo lub pojedynczych komórek oraz dekonwolucji zbiorczych danych dotyczących ekspresji genów

## *Przykładowy Kod*

Przykładowy kod został podany poniżej
